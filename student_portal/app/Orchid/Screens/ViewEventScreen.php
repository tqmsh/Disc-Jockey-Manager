...
class ViewEventScreen extends Screen
{
    ...
    public function query(): iterable
    {
        ...
        return [
            ...
            'registered_events' => Events::whereIn('id', $registered_event_ids)->latest('events.created_at')->paginate(request()->query('pagesize', 10)),
            'eventInvitations' => Events::whereIn('id', $invitedEvents)->latest('events.created_at')->paginate(request()->query('pagesize', 10))
        ];
    }
