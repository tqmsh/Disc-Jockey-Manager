            ...
            >
                <div class="modal-header">
                    <div style="display: flex; gap:5px;">
                        ...
                        @if(DB::table('video_tutorials')->where('portal', 1)->where('route_name', $video_tutorial_appropriate_route)->exists())
                            <a target="_blank" href="{{DB::table('video_tutorials')->where('portal', 1)->where('route_name', $video_tutorial_appropriate_route)->first()->url}}">
