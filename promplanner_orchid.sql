...
(8, 1.3, 'Guide for the students', 3, '2023-04-08 04:30:27', '2023-04-08 04:30:27'),
(9, 1.4, 'Guide for the vendors', 4, '2023-04-08 04:30:42', '2023-04-08 04:30:42');
...
ALTER TABLE `lessons`
  ...
  ADD KEY `guide_id_lesson` (`guide_id`);
...
ALTER TABLE `sections`
  ADD PRIMARY KEY (`id`),
  ADD KEY `guide_id_section` (`guide_id`);
...
--
ALTER TABLE `lessons`
  ADD CONSTRAINT `guide_id_lesson` FOREIGN KEY (`guide_id`) REFERENCES `guides` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `sections`
  ADD CONSTRAINT `guide_id_section` FOREIGN KEY (`guide_id`) REFERENCES `guides` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
