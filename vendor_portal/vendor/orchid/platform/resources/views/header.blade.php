...
@push('scripts')
    ...
    @php
        $tourElements = \App\Models\TourElement::where("portal", 2)->where('screen', str_replace('/{method?}', '', Illuminate\Support\Facades\Route::current()->uri()))->orderBy('order_element', 'asc')->get()->toArray();
        $arr_tourels = [];
