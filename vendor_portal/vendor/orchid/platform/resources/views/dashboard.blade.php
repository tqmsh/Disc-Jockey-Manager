        ...
        <div class="d-md-flex align-items-start flex-column d-sm-block h-full">
            ...
            <header style="justify-content: space-between;" class="d-sm-flex d-md-block p-3 mt-md-4 w-100 d-flex align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    @if(DB::table('video_tutorials')->where('portal', 2)->where('route_name', request()->route()->getName())->exists())
                        <a style="margin-left:8px;" class="d-flex align-items-center d-md-none" target="_blank" href="{{DB::table('video_tutorials')->where('portal', 2)->where('route_name', request()->route()->getName())->first()->url}}">
    ...
    <div class="mt-3 mt-md-4">
        ...
        <div class="@hasSection('navbar') @else d-none d-md-block @endif layout v-md-center">
            <header class="d-none d-md-block col-xs-12 col-md p-0">
                <h1 class="m-0 fw-light h3 text-black" id="titlebig">@yield('title')</h1>
