<div class="layout v-md-center">
    ...
    <nav class="col-xs-12 col-md-auto ms-auto p-0">
        <ul class="nav command-bar d-flex align-items-center">
            <li class="mx-2">
                <a class="btn btn-lg btn-link fw-bold" href="https://trello.com/b/sAsMFes7/prom-planner-internal" target="_blank"> 
                    Bugs
                </a>
            </li>
            <li class="mx-2">
            ...
            <li class="mx-lg-2">
                <a class="btn btn-icon" href="https://www.pinterest.ca/promplannerapp/" target="_blank">
            ...
            <li class="mx-lg-2">
                <a class="btn btn-icon" href="https://tiktok.com/@promplannerapp" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" width="34px" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M448,209.91a210.06,210.06,0,0,1-122.77-39.25V349.38A162.55,162.55,0,1,1,185,188.31V278.2a74.62,74.62,0,1,0,52.23,71.18V0l88,0a121.18,121.18,0,0,0,1.86,22.17h0A122.18,122.18,0,0,0,381,102.39a121.43,121.43,0,0,0,67,20.14Z"/></svg>
                </a>
            </li>
            <li class="mx-lg-2">
                <a class="btn btn-icon" href="https://soundcloud.com/prom-planner" target="_blank">
            ...
            <li class="mx-lg-2">
                <a class="btn btn-icon" href="https://www.linkedin.com/company/promplanner/" target="_blank">
