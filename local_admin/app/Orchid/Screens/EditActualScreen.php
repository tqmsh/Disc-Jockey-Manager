...
class EditActualScreen extends Screen
{   
    public $event;
    ...
    public function commandBar(): iterable
    {
        return [
            ...
            Link::make('Back')
                ->icon('arrow-left')
                ->route('platform.actual.list', ['event_id' => $this->event->id])
                ->type(Color::DEFAULT()),
        ];
    }
        ...
        try{
            ...
            if(request()!=null){
                ...
                if($item != null){
                    ...
                    $item->actual = ($amount == null) ? $item->actual : ($amount);
