        ...
        <div class="d-md-flex align-items-start flex-column d-sm-block h-full">
            ...
            <header class="d-sm-flex d-md-block p-3 mt-md-4 w-100 d-flex align-items-center">
                ...
                @if(DB::table('video_tutorials')->where('portal', 0)->where('route_name', request()->route()->getName())->exists())
                    <a style="margin: 0 auto;" class="d-flex align-items-center d-md-none" target="_blank" href="{{DB::table('video_tutorials')->where('portal', 0)->where('route_name', request()->route()->getName())->first()->url}}">
