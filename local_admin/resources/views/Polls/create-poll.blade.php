...
<section class="max-w px-6 pb-2 pt-1 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
        ...
        <div id="form-wrapper" class="grid grid-cols-2 gap-3 mt-4 sm:grid-cols-2">
            ...
            <div date-rangepicker class="flex flex-row col-span-2">
                <div class="relative">
                    ...
                    <input name="start_date" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 ml-10 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date start">
                </div>
                ...
                <div class="relative">
                    <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                        ...
                        <input name="end_date" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 ml-10 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date end">
                    </div>
            </div>
    ...
    <div class="flex flex-row items-center">
        ...
        <input id="option_1" name="option_1" type="text" class="block w-full px-4 py-2 mt-0 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" placeholder="Type your answer here">
    </div>


            <div class="flex flex-row items-center ">
                <label class="text-gray-700 dark:text-gray-200 font-bold p-2 text-lg" for="option_2">2</label>
                <input id="option_2" name="option_2" type="text" class="block w-full px-4 py-2 mt-0 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" placeholder="Type your answer here">
            </div>
        ...
        <button type="submit" class="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Create</button> 
</div>
